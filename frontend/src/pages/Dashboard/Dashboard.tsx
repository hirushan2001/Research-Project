...
export const Dashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-10 fade-in pb-12">
      ...
      <section className="relative overflow-hidden rounded-3xl p-8 md:p-10 border border-slate-800/40 bg-gradient-to-br from-[#0c1222] via-[#090d16] to-[#070b12] shadow-2xl">
        ...
        <div className="relative max-w-4xl space-y-5">
          <span className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-xs font-bold bg-emerald-500/10 text-emerald-400 border border-emerald-500/15">
            <Sparkles className="w-3.5 h-3.5 animate-pulse text-emerald-400" />
            <span>AI-Driven Agriculture Engineering Research</span>
          </span>
          
          <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight text-white leading-tight font-outfit">
          ...
          <p className="text-sm md:text-base leading-relaxed text-slate-400 font-sans max-w-3xl">
        ...
        <div className="relative mt-10 pt-8 border-t border-slate-800/60 grid grid-cols-2 md:grid-cols-4 gap-6">
          <div className="flex gap-3">
            <div className="p-2.5 h-10 w-10 rounded-xl bg-slate-900/60 border border-slate-800/40 text-emerald-400">
              <Zap className="w-5 h-5" />
            </div>
            <div>
              <h4 className="text-xs font-bold text-slate-200 uppercase tracking-wider">Inference Speed</h4>
              <p className="text-[11px] text-slate-400 font-medium">Sub-second assessments</p>
            </div>
          </div>

          <div className="flex gap-3">
            <div className="p-2.5 h-10 w-10 rounded-xl bg-slate-900/60 border border-slate-800/40 text-teal-400">
              <BarChart3 className="w-5 h-5" />
            </div>
            <div>
              <h4 className="text-xs font-bold text-slate-200 uppercase tracking-wider">Grading Metric</h4>
              <p className="text-[11px] text-slate-400 font-medium">G1 - G4 standard scale</p>
            </div>
          </div>

          <div className="flex gap-3">
            <div className="p-2.5 h-10 w-10 rounded-xl bg-slate-900/60 border border-slate-800/40 text-lime-400">
              <ShieldCheck className="w-5 h-5" />
            </div>
            <div>
              <h4 className="text-xs font-bold text-slate-200 uppercase tracking-wider">Inference Engine</h4>
              <p className="text-[11px] text-slate-400 font-medium">Safe fallback workflows</p>
            </div>
          </div>

          <div className="flex gap-3">
            <div className="p-2.5 h-10 w-10 rounded-xl bg-slate-900/60 border border-slate-800/40 text-sky-400">
              <BookOpen className="w-5 h-5" />
            </div>
            <div>
              <h4 className="text-xs font-bold text-slate-200 uppercase tracking-wider">Academic Scope</h4>
              <p className="text-[11px] text-slate-400 font-medium">Final Year Project</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="glass-panel p-6 rounded-2xl relative overflow-hidden group hover:border-emerald-500/20 transition-all duration-300">
          ...
          <h3 className="mt-2 text-3xl font-extrabold text-white tracking-tight">{totalScans}</h3>
        ...
        <div className="glass-panel p-6 rounded-2xl relative overflow-hidden group hover:border-lime-500/20 transition-all duration-300">
          <div className="absolute right-3 top-3 opacity-10 group-hover:scale-110 transition-transform duration-300">
            <Percent className="w-12 h-12 text-lime-400" />
          </div>
        ...
        <div className="glass-panel p-6 rounded-2xl relative overflow-hidden group hover:border-sky-500/20 transition-all duration-300">
          <div className="absolute right-3 top-3 opacity-10 group-hover:scale-110 transition-transform duration-300">
            <Timer className="w-12 h-12 text-sky-400" />
          </div>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-4 glass-panel p-6 rounded-2xl flex flex-col justify-between border border-slate-800/40">
          <div>
            <h3 className="text-base font-bold text-slate-100 uppercase tracking-wider">Quality Spread</h3>
            <p className="text-[11px] text-slate-400 mt-0.5">Classification counts from current session</p>
            ...
            {totalScans > 0 ? (
              <div className="mt-8 space-y-4.5">
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between text-xs font-semibold">
                    ...
                    <span className="text-slate-200">{gradeCounts.G1} ({Math.round(gradeCounts.G1 / totalScans * 100)}%)</span>
                  </div>
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between text-xs font-semibold">
                    ...
                    <span className="text-slate-200">{gradeCounts.G2} ({Math.round(gradeCounts.G2 / totalScans * 100)}%)</span>
                  </div>
                  <div className="h-2 rounded-full bg-slate-800 overflow-hidden">
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between text-xs font-semibold">
                    ...
                    <span className="text-slate-200">{gradeCounts.G3} ({Math.round(gradeCounts.G3 / totalScans * 100)}%)</span>
                  </div>
                  <div className="h-2 rounded-full bg-slate-800 overflow-hidden">
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between text-xs font-semibold">
                    ...
                    <span className="text-slate-200">{gradeCounts.G4} ({Math.round(gradeCounts.G4 / totalScans * 100)}%)</span>
                  </div>
                  <div className="h-2 rounded-full bg-slate-800 overflow-hidden">
              ...
              <div className="mt-12 flex flex-col items-center justify-center text-center p-4">
                <AlertCircle className="w-8 h-8 text-slate-600 animate-pulse mb-3" />
                <h5 className="text-xs font-bold text-slate-400">No Assessment Records</h5>
          ...
          <div className="mt-8 pt-4 border-t border-slate-800/60 flex items-center justify-between text-xs">
